...
SECRET_KEY = 'django-insecure-n=te972_v4yyndkyf_-zb(-rd3(t!ia)k5p*rhtd3d7xaz2ws7'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # Các lớp authentication khác nếu cần
    ],
    # Các cấu hình khác của REST framework nếu cần
}
